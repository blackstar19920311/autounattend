...
export default function App() {
  ...
  const handleGenerate = useCallback(() => {
    ...
    try {
      ...
      setXml(generatedXml);
      setErrors({});
      // A figyelmeztetések NEM blokkolják a generálást, de látszaniuk kell:
      // nyílt szöveges jelszó, CLEAN ALL, kikapcsolt UAC, stb.
      setWarnings(Array.from(new Set(validation.warnings || [])));
      showStatus('success', t('app.status.success'));
    } catch (err) {
      console.error('XML generálási hiba:', err);
      setWarnings([]);
      showStatus('error', `${t('app.status.error.generation')} (${err?.message || err})`);
    }
      ...
      <div className="app-layout">
        ...
        <main className="main-content">
          ...
          <div className="scrollable-sections" onScroll={handleMainScroll}>
            ...
            <UserManual />
            <div id="presets">
              <PresetsSection config={config} setConfig={updateConfig} resetPresetRef={resetPresetRef} />
            </div>
            <div id="system-info">
              <SystemInfoSection config={config} setConfig={updateConfig} errors={errors} />
            </div>
            <div id="partitioning">
              <PartitionSection config={config} setConfig={updateConfig} errors={errors} />
            </div>
            <div id="bypasses">
              <BypassSection config={config} setConfig={updateConfig} />
            </div>
            <div id="wifi">
              <WifiSection config={config} setConfig={updateConfig} errors={errors} />
            </div>
            <div id="user-account">
              <UserAccountSection config={config} setConfig={updateConfig} errors={errors} />
            </div>
            <div id="personalization">
              <PersonalizationSection config={config} setConfig={updateConfig} />
            </div>
            <div id="privacy">
              <PrivacySection config={config} setConfig={updateConfig} />
            </div>
            <div id="performance">
              <PerformanceSection config={config} setConfig={updateConfig} />
            </div>
            <div id="bloatware">
              <BloatwareSection config={config} setConfig={updateConfig} />
            </div>
            <div id="custom-scripts">
              <CustomScriptsSection config={config} setConfig={updateConfig} errors={errors} />
            </div>
          </div>
