export const WINGET_APPS = [
  ...
  { id: 'Ghisler.TotalCommander', name: 'Total Commander', source: 'winget', defaultLocation: 'D:\\Apps\\TotalCommander', useOverride: '/A ' },
  { id: 'Valve.Steam', name: 'Steam', source: 'winget', defaultLocation: 'D:\\Games\\Steam' },
  { id: 'EpicGames.EpicGamesLauncher', name: 'Epic Games Launcher', source: 'winget', defaultLocation: 'D:\\Apps\\EpicGames', useOverride: '/q INSTALLDIR' },
